...
% Calculo polos deseados
p_deseados = [-1.5 -1.6 -1.7 -1.8 -1.9 -2.0];

% Valores de la diagonal
diag_vals = [0.8, 0.9, 1.1];

% Inicializar matriz B nueva
...
GanananciasControlador = place(matrizA, matriz_B_new, p_deseados);
